...
const ChatContextProvider = (props) => {
  const {messages, knowledge, addMessage, setKnowledge, clearChat} = useMessageCollection();

  return (
    <ChatContext.Provider value={[messages, knowledge, addMessage, setKnowledge, clearChat]}>
      {props.children}
